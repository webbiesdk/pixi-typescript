...
declare namespace PIXI {
    ...
    export namespace GroupD8 {
        ...
        export function uX(ind: number): number | undefined;
        export function uY(ind: number): number | undefined;
        export function vX(ind: number): number | undefined;
        export function vY(ind: number): number | undefined;
        export function inv(rotation: number): number;
        export function add(rotationSecond: number, rotationFirst: number): number | undefined;
